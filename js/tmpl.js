...
table_templates = {
    ...
    company: '<tr id="row_<%= id %>" class="<%= even %>" data-project-id="<%= id %>"><td><%= company_name %></a></td><td><%= registration_number %></td><td><%= locationen %></td><td><%= invest_agree %></td<td><%= centralpay %></td><td><%= localpay %></td><td><%= totalpay %></td></tr>'
};
